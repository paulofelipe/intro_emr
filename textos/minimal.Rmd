...
author: |
    ...
    | \textnormal{\sffamily Ministério da Economia}
output: 
  pdf_document:
    number_section: true
...
$$\hat{\text{COST}}_i = \frac{\sum_c USE_{csi} \times \hat{p}_{cs} + FAC_{labour,i} \times \hat{\text{P1LAB}}_i + FAC_{capital,i} \times \hat{\text{P1CAP}_i}}{\text{V1TOT}_i}$$
